...
function vw_kids_font_url() {
	...
	$font_family[] = 'Roboto:100,200,300,400,500,600,700,800,900';
...
function vw_kids_ie_stylesheet(){
	wp_enqueue_style('vw-kids-ie', get_template_directory_uri().'/css/ie.css');
	wp_style_add_data( 'vw-kids-ie', 'conditional', 'IE' );
}
add_action('wp_enqueue_scripts','vw_kids_ie_stylesheet');
...
define('VW_KIDS_FREE_THEME_DOC','https://www.vwthemesdemo.com/docs/free-vw-kids/','vw-kids');
define('VW_KIDS_SUPPORT','https://wordpress.org/support/theme/vw-kids/','vw-kids');
define('VW_KIDS_REVIEW','https://wordpress.org/support/theme/vw-kids/reviews','vw-kids');
define('VW_KIDS_BUY_NOW','https://www.vwthemes.com/themes/kids-wordpress-theme/','vw-kids');
define('VW_KIDS_LIVE_DEMO','https://www.vwthemes.net/vw-kids-pro/','vw-kids');
define('VW_KIDS_PRO_DOC','https://www.vwthemesdemo.com/docs/vw-kids-pro/','vw-kids');
define('VW_KIDS_FAQ','https://www.vwthemes.com/faqs/','vw-kids');
define('VW_KIDS_CONTACT','https://www.vwthemes.com/contact/','vw-kids');
define('VW_KIDS_CHILD_THEME','https://developer.wordpress.org/themes/advanced-topics/child-themes/','vw-kids');
define('VW_KIDS_CREDIT','https://www.vwthemes.com/themes/free-kids-wordpress-theme/','vw-kids');
