...
= 0.2 =
* Fixed the Php error in middle-header.php.
...
= 0.3.1 =
* Resolved the PHP Warning issue


== Resources ==

VW Kids WordPress Theme, Copyright 2019 VWthemes
VW Kids is distributed under the terms of the GNU GPL.

Theme is Built using the following resource bundles.

* CSS bootstrap.css
-- Copyright 2011-2018, licensed under MIT License
-- https://github.com/twbs/bootstrap/blob/master/LICENSE
    
* JS bootstrap.js
-- Copyright 2011-2018 (https://github.com/twbs/bootstrap/graphs/contributors), licensed under MIT License
-- https://github.com/twbs/bootstrap/blob/master/LICENSE
...
Header Image, Copyright Piotr Lohunko
License: CC0 1.0 Universal (CC0 1.0)
...
License: CC0 1.0 Universal (CC0 1.0)
Source: https://stocksnap.io/photo/WNGCRQGLJR

Product Image, Copyright Revac Film's&Photography
License: CC0 1.0 Universal (CC0 1.0)
Source: https://stocksnap.io/photo/BCXFS2DZDS

Product Image, Copyright Torsten Dettlaff
License: CC0 1.0 Universal (CC0 1.0)
Source: https://stocksnap.io/photo/GDOCX7A59G

* All the icons taken from genericons licensed under GPL License.
http://genericons.com/

== Theme Documentation ==
Documentation : https://www.vwthemesdemo.com/docs/free-vw-kids/